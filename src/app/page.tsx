...
export default function Home() {
  useEffect(() => {
    ...
    const initSwiper = () => {
      ...
      if (swiperContainer && (window as any).Swiper) {
        new (window as any).Swiper('.clients-slider', {
          speed: 400,
          loop: true,
          autoplay: {
            delay: 5000,
    ...
    const checkInterval = setInterval(() => {
      ...
      const swiperDone = initSwiper();

      if (isotopeDone && lightboxDone && swiperDone) {
  ...
  return (
    <>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 3 }}>
          <div className="row justify-content-center">
            <div className="col-xl-6 col-lg-8">
              ...
              <div>
                <a href="/azone-projects-profile.pdf" className="btn-profile" download target="_blank" rel="noopener noreferrer">
                  Download Business Profile <i className="ri-download-line"></i>
                </a>
              </div>
            </div>
          </div>
      ...
      <main id="main">
        ...
        {/* ======= SEO Content Section ======= */}
        <section id="assignment-seo" className="services section-bg">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              <h2>Top-Rated Assignment Writing Services in UAE</h2>
              <p>Why Choose Us for Assignment Help?</p>
            </div>
            <div className="row">
              <div className="col-lg-12">
                <p>
                  Azone Projects offers the <strong>best assignment writing services in Dubai, Sharjah, and Abu Dhabi</strong>. Our team of expert academic writers provides high-quality assistance for:
                </p>
                <ul>
                  <li><strong>Thesis Writing & Dissertation Help:</strong> Comprehensive support for PhD and Master's students.</li>
                  <li><strong>MBA Assignment Help:</strong> Strategic management, finance, and marketing assignments.</li>
                  <li><strong>Essay Writing Services:</strong> Custom essays, research papers, and case studies.</li>
                  <li><strong>University Projects:</strong> Graduation projects, engineering reports, and programming tasks.</li>
                </ul>
                <p>
                  We guarantee <strong>plagiarism-free content</strong>, on-time delivery, and 24/7 support for all your academic needs in the UAE.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="reviews" className="services section-bg">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              <h2>Testimonials</h2>
              <p>Student Reviews</p>
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div className="icon-box">
                  <div className="icon"><i className="bx bxs-quote-alt-left"></i></div>
                  <h4><a href="">Sarah A. - Dubai</a></h4>
                  <p>"Azone Projects saved my semester! Their assignment help is top-notch. I got an A on my thesis thanks to their expert guidance. Highly recommended for any student in UAE."</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                <div className="icon-box">
                  <div className="icon"><i className="bx bxs-quote-alt-left"></i></div>
                  <h4><a href="">Mohammed K. - Sharjah</a></h4>
                  <p>"Best assignment writing service I've found. They understood my requirements perfectly and delivered on time. The quality of writing was excellent."</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                <div className="icon-box">
                  <div className="icon"><i className="bx bxs-quote-alt-left"></i></div>
                  <h4><a href="">Fatima R. - Abu Dhabi</a></h4>
                  <p>"I was struggling with my graduation project, but Azone Projects provided amazing support. Their team is very professional and knowledgeable."</p>
                </div>
              </div>
            </div>
          </div>
