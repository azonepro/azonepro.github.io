...
export const metadata: Metadata = {
  ...
  title: {
    ...
    default: "Best Assignment Writing & Assignment Help in UAE | Azone Projects",
  },
  description: "Azone Projects: #1 Rated for Assignment Writing, Assignment Help, Thesis Writing, and Graduation Projects in UAE (Dubai, Sharjah, Abu Dhabi). Get Expert Help Now.",
  keywords: [
    // Primary Keywords
    "Assignment Writing",
    "Assignment Help",
    "Thesis Writing",
    "Assignment Writing Services UAE",
    "Best Assignment Help Dubai",
    "Assignment Help Sharjah",
    "Thesis Writing Services UAE",
